...
import {
  ...
  FaShippingFast, FaHandshake, FaCalendarAlt, FaExchangeAlt, FaTimesCircle
} from 'react-icons/fa';
...
const AdminNotifications = () => {
  ...
  const getIconByType = (type) => {
    switch (type) {
      ...
      case 'order_canceled': return <FaTimesCircle className="canceled-icon" />; // 👈 new
        ...
        <div className="notifications-header">
          ...
          <div className="header-actions">
            ...
            <select className="filter-select" value={filter} onChange={(e) => setFilter(e.target.value)}>
              ...
              <option value="order_canceled">Canceled Orders</option> {/* 👈 new */}
          ...
          <div className="notifications-container">
            {filteredNotifications.length === 0 ? (
              ...
              filteredNotifications.map((notification) => (
                <div className={`notification-card ${notification.isRead ? 'read' : 'unread'} ${notification.type === 'order_canceled' ? 'canceled' : ''}`}>
