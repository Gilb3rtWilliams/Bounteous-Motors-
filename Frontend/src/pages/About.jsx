...
const About = () => {
  ...
  const subMessage = useTypingEffect(
    "Discover our journey, mission, and commitment to excellence in the automotive industry.",
    60,
  );
      ...
      <div className="about-content">
        ...
        <section className="company-overview">
          ...
          <div className="overview-content">
            <div className="overview-text">
              <p>
                Founded in 2010, Bounteous Motors has grown from a modest
                dealership in Nairobi to East Africa's leading automotive
                marketplace. Our journey is marked by continuous innovation,
                unwavering commitment to quality, and a deep understanding of
                the African automotive market.
              </p>
              <p>
                Today, we serve customers across seven countries, offering a
                comprehensive range of services from vehicle trading to premium
                maintenance solutions. Our success is built on the trust of over
                10,000 satisfied customers and partnerships with leading
        ...
        <section className="mission-vision">
          <div className="mission-content">
            <div className="mission-box">
              <h2>Our Mission</h2>
              <p>
                To revolutionize the African automotive marketplace by providing
                unparalleled access to quality vehicles through innovative
            ...
            <div className="vision-box">
              <h2>Our Vision</h2>
              <p>
                To be the most trusted and comprehensive automotive platform in
                Africa, setting new standards for quality, transparency, and
          ...
          <div className="tech-features">
            <div className="tech-item">
              ...
              <p>
                ...
                match you with your perfect vehicle based on preferences,
            ...
            <div className="tech-item">
              ...
              <p>
                Experience detailed 360° views and virtual tours of vehicles
            ...
            <div className="tech-item">
              ...
              <p>
                Real-time market analysis and price comparison tools ensure you
            ...
            <div className="tech-item">
              ...
              <p>
                Streamlined, paperless processes for all transactions and
        ...
        <section className="future-vision">
          ...
          <div className="vision-content">
            <p>
              As we continue to grow and evolve, our commitment to innovation
              and excellence remains unwavering. Our future initiatives include:
            </p>
            <ul>
        ...
        <section className="contact-cta">
          ...
          <p>
            Whether you're looking to buy, sell, or simply learn more about our
